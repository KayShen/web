...
/***/ function(module, exports, __webpack_require__) {
	...
	$(document).ready(function(event) {
	  return $('body').on('click', '.answer', function(e) {
	    ...
	    answer = $(this).find('.answer-text').data('a');
	    postAnswer({
	      question: question,
	      answer: answer
	    });
	    if (Page.bb.currentIdx === 9) {
	      if (confirm('Do you wnat to do more questions?')) {
	        return location.href = 'survey.html?q=11';
	      }
	    } else if (Page.bb.currentIdx === Page.bb.itemsCount - 1) {
